#!/usr/bin/env python3
"""Insert CATEGORY_ICONS constant into Dashboard.tsx after CATEGORIES."""
...
for i, line in enumerate(lines):
    if 'win:' in line and 'Win' in line and 'F59E0B' in line:
        in_categories = True
    if in_categories and line.strip() == '};':
        insert_at = i + 1
        break
...
if insert_at:
    ...
    print(f'Inserted CATEGORY_ICONS at line {insert_at}')
else:
